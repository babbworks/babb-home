...
*Workpads is under active development.*

</div>
<div class="column-right">
  <h3>Updates</h3>
  <ul>
    <li><a href="/categories/workpads/">Category: Workpads</a></li>
    <li><a href="https://x.com/workpads">Posts on X</a></li>
    <li><a href="https://instagram.com/workpads">Posts on Instagram</a></li>
  </ul>
  <h3>Sites</h3>
  <ul>
    <li><a href="https://workpads.babb.tel">workpads.babb.tel</a></li>
    <li><a href="https://workpads.org">workpads.org</a></li>
  </ul>
  <h3>Project</h3>
  <ul>
    <li><a href="https://github.com/babbworks/workpads">GitHub</a></li>
  </ul>
</div>
</div>