...
<div class="home">
<img src="/assets/images/screengrabs/workwarrior-newprofile.png">
<br><br>

 <p>This project is based entirely on open source tools and extensions. Its purpose is to grow the ecosystem that supports these command line tools and to increase the financial supports available for the creators of the individual projects and their contributors.</p> 
 <p>Each project that Workwarrior relies on is the result of the creative and voluntary efforts of people around the world. The goal of this project is to highlight these achievements by bringing together great tools within one useable system that can amplify their impact.</p>
...
<ul>
    <li>
      <a href="categories/workwarrior/">View</a></li>
    <li>
